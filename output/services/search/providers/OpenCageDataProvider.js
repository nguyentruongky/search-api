...
exports.getPlaces = function (query) { return __awaiter(void 0, void 0, void 0, function () {
    var key, url, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                key = process.env.OPEN_CAGE_DATA_KEY;
                url = "https://api.opencagedata.com/geocode/v1/geojson?q=" + query + "&key=" + key + "&limit=20&no_annotations=1";
